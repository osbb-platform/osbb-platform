...
const quorumArticleSlug = "kvorum-za-ploshcheyu-yak-ne-zirvaty-zbory";
          ...
          <div className="osbb-container osbb-article__layout">
            ...
            <div className="osbb-article__prose">
              <p>
                ...
                причина буденна: у день зборів виявляється, що кворуму немає, а
                порахувати його заздалегідь ніхто не спробував. Далі —
                перенесення, нові оголошення, втрачений місяць і відчуття, що
                будинок не може ухвалити навіть просте рішення.
              </p>

              <p>
                Кворум на загальних зборах співвласників рахується не за
                кількістю присутніх людей, а за площею, якою вони володіють. Це
                проста арифметика, але вона змінює саму підготовку зборів:
                важливо не скільки сусідів прийде, а чиї квартири разом дадуть
                потрібну частку площі будинку.
              </p>

              <h2 id="wrong-count">Чому голови рахують кворум неправильно</h2>

              <p>
                Типова помилка — рахувати за квартирами. У будинку 98 квартир,
                прийшло 55 власників, здається, що більшість є. Але якщо серед
                відсутніх — власники великих трикімнатних квартир і нежитлових
                приміщень на першому поверсі, за площею більшості може не бути.
              </p>

              <p>
                Друга помилка — вважати, що одна квартира дає один голос. Якщо
                квартира у спільній власності, кожен співвласник розпоряджається
                своєю часткою площі. Двоє власників однієї квартири можуть
                проголосувати по-різному, і кожна частка врахується окремо.
              </p>
              ...
              <ul>
                ...
                <li>Площу, яка припадає на кожну квартиру та приміщення.</li>
                <li>
                  Частку площі, яку разом дають власники, що вже підтвердили
                  участь.
                </li>
                <li>
              ...
              <p>
                ...
                накопичується частка площі, коли підтверджують участь власники
                різних груп приміщень.
              </p>
              ...
              <p>
                ...
                кворум не збереться навіть за участі всіх інших груп. Саме з
                ними варто починати роботу, а не з тими, до кого простіше дійти.
              </p>
              ...
              <p>
                Ситуація стандартна: квартира є, власник живе в іншому місті або
                за кордоном, телефон у списку правління десятирічної давнини.
                Тут допомагає послідовність, а не поспіх.
              </p>

              <ol>
                <li>
                  Оновіть список власників і контактів до розсилки оголошення, а
                  не після.
                </li>
                <li>
                ...
                <li>
                  Фіксуйте, хто підтвердив участь, і рахуйте площу після кожного
                  підтвердження.
                </li>
                <li>
                  Тримайте окремий перелік «не вийшли на зв’язок» — це задача на
                  наступні тижні, а не аварія в день зборів.
                </li>
              </ol>
              ...
              <div className="osbb-article__notice">
                ...
                <p>
                  Порядок скликання зборів, форма повідомлення співвласників і
                  оформлення рішень визначені законом і статутом вашого ОСББ.
                  Перед зборами перевірте строки повідомлення і формулювання
                  питань порядку денного за своїм статутом.
                </p>
              </div>
              ...
              <p>
                Розмите питання зриває збори так само надійно, як відсутність
                кворуму. Формулювання «обговорити ремонт покрівлі» не дає
                результату: обговорили — і що? Питання має бути таким, щоб на
                нього можна було відповісти «за» або «проти».
              </p>

              <p>
                Порівняйте два формулювання. «Питання ремонту покрівлі» — і
                «Затвердити ремонт покрівлі над під’їздом №3 у межах
                затвердженого кошторису із залученням підрядника за результатами
                відбору». Друге можна поставити на голосування, перше — ні.
              </p>
              ...
              <p>
                ...
                співвласники не пам’ятають, що саме ухвалили, а через рік не
                можуть знайти протокол. Тому корисно тримати протоколи, звіти й
                кошториси там, де їх знайде будь-який співвласник без дзвінка
                голові.
              </p>

              <p>
                Практика проста: після кожних зборів протокол має з’явитись у
                доступному місці протягом кількох днів, а не «коли буде час». Це
                знімає половину майбутніх питань і суперечок.
              </p>
            </div>
          </div>
        ) : (
      ...
      <Section tone="deep">
        <div className="osbb-narrow">
          ...
          <p className="osbb-lead osbb-lead--deep">
            Порядок денний, хід голосування, підсумкові відсотки і протокол PDF
            доступні кожному співвласнику за 6-значним кодом.
          </p>

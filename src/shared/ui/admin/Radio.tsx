    ...
    >
      <span className="relative inline-flex h-5 w-5 flex-none">
        <input
          ...
          type="radio"
          disabled={disabled}
          className={cx("peer absolute inset-0 m-0 cursor-inherit appearance-none rounded-full", className)}
          {...rest}
        />
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 flex items-center justify-center rounded-full border-2 border-[var(--cms-border-strong)] bg-[var(--cms-surface-elevated)] transition-colors peer-checked:border-[var(--cms-accent-primary)] peer-focus-visible:shadow-[0_0_0_3px_color-mix(in_srgb,var(--cms-ring)_35%,transparent)]"
        >

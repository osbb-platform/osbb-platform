...
export type SelectProps = { invalid?: boolean } & React.SelectHTMLAttributes<HTMLSelectElement>;
  ...
  return (
    <div className="relative">
      <select
        ...
        className={cx(
          "h-11 w-full pl-3.5 pr-9 text-sm rounded-[var(--r-lg)] appearance-none cursor-pointer transition-colors",
          "bg-[var(--cms-surface-elevated)] text-[var(--cms-text)]",
          invalid
            ? "border border-[var(--cms-danger-border)]"

...
export type TextareaProps = { invalid?: boolean } & React.TextareaHTMLAttributes<HTMLTextAreaElement>;
...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(function Textarea(
  ...
  return (
    <textarea
      ...
      className={cx(
        "w-full p-3 text-sm leading-[1.6] rounded-[var(--r-lg)] resize-y transition-colors",

export const adminSurfaceClass =
  "rounded-3xl border bg-[var(--cms-surface)] border-[var(--cms-border)] text-[var(--cms-text)]";

export const adminInsetSurfaceClass =
  "rounded-2xl border bg-[var(--cms-surface-elevated)] border-[var(--cms-border)] text-[var(--cms-text)]";

export const adminMutedSurfaceClass =
  "rounded-2xl border bg-[var(--cms-surface-muted)] border-[var(--cms-border)] text-[var(--cms-text)]";

export const adminCardPaddingClass = "p-6";
export const adminInsetPaddingClass = "p-4";

export const adminTitleClass =
  "text-xl font-semibold text-[var(--cms-text)]";

export const adminSectionTitleClass =
  "text-lg font-semibold text-[var(--cms-text)]";

export const adminBodyClass =
  "text-sm leading-6 text-[var(--cms-text-muted)]";

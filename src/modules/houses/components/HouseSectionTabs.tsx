    ...
    <div className="relative min-w-0">
      ...
      >
        ...
        {overflowBlocks.length > 0 ? (
          <div ref={menuRef} className="relative z-40 flex-none">
            <button
              type="button"
              aria-haspopup="menu"
            ...
            {menuOpen ? (
              <div
                role="menu"
                className="absolute right-0 top-full z-[80] mt-2 min-w-[220px] rounded-[var(--r-lg)] border border-[var(--cms-border)] bg-[var(--cms-surface-elevated)] p-1.5 shadow-[var(--cms-shadow-lg)]"
              >

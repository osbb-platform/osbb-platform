  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="inline-flex items-center justify-center rounded-[var(--r-lg)] bg-[var(--cms-primary)] px-5 py-3 text-sm font-medium text-[var(--cms-primary-foreground)] transition hover:opacity-90 disabled:opacity-60"
      >

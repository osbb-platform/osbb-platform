-- P05 T6.1: concurrency-safe automatic plan lifecycle executor.
-- Invocation boundary is added separately in T6.2.
...
comment on function public.run_house_plan_automation(timestamptz, integer) is
  'Processes due published plan tasks with SKIP LOCKED catch-up semantics. Service-role only.';
